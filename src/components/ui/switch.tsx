  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block rounded-full bg-background ring-0 transition-transform group-data-[size=default]/switch:size-3.5 group-data-[size=sm]/switch:size-3 group-data-[size=default]/switch:group-[data-state=checked]/switch:translate-x-[calc(100%-2px)] group-data-[size=sm]/switch:group-[data-state=checked]/switch:translate-x-[calc(100%-2px)] dark:group-[data-state=checked]/switch:bg-primary-foreground group-data-[size=default]/switch:group-[data-state=unchecked]/switch:translate-x-0 group-data-[size=sm]/switch:group-[data-state=unchecked]/switch:translate-x-0 dark:group-[data-state=unchecked]/switch:bg-foreground"
      />
    </SwitchPrimitive.Root>
  )
}
